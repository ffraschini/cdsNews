    ...
    <header>
		...
		<div id="divThankYou" >
				<section id="SecContactUs">
					<div id="titlesThankYou"><h22 id="ContactUs">Thank you for contacting us!</h22>
						<h4>A representative will be in touch with you shortly.</h4>												
					</div>
